...
experience = [
    ...
    },
    {
        ...
        'skills': ['Python', 'Flask', 'OpenAI GPT-4', 'AWS SQS', 'DynamoDB', 'Celery', 'AWS App Runner', 'AWS Fargate', 'Lambda', 'RESTful API']
    },
    {
        ...
        'skills': ['gRPC', 'Kafka', 'Celery', 'AWS', 'GCP', 'Docker', 'Kubernetes', 'API Development', 'Backend Services']
    },
    {
        ...
        'skills': ['Apache Airflow', 'Prefect', 'React', 'TypeScript', 'Angular', 'CI/CD', 'Automated Testing', 'Data Integration', 'Agile/Scrum', 'Jira']
    }
]
